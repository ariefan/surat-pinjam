...
$routes->post('api/auth/profile', 'Api\Auth::profile');
$routes->post('api/auth/save-fcmtoken', 'Api\Auth::saveFcmtoken');
$routes->post('api/notifications/send/(:num)/(:num)/(:any)', 'Api\Auth::saveFcmtoken');
$routes->resource('todo');
$routes->resource('api/surattugas');
$routes->post('api/todo/(:num)/toggle', 'Api\Todo::toggle/$1');
