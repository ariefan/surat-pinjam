...
<div class="container mt-3">
	...
	?>
	<form method="post" action="<?= base_url('surattugas/uploads') . "/$id" ?>" enctype="multipart/form-data">
		<div class="form-group">
			<!-- <label for="">Bukti/Laporan Pelaksanaan Tugas (wajib pdf)</label> -->
			<label for="">Laporan Pertanggungjawaban (pdf maks 2MB)</label>
			<input type="file" accept="application/pdf" name="berkas" required="" class="form-control"
