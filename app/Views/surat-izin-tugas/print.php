...
<div>
    <div style="text-align:center;" class="col-sm-12">
        <!-- <div style="font-size:13pt;"><b>SURAT IZIN DAN TUGAS</b></div> -->
        <div style="font-size:13pt;"><b>SURAT IZIN</b></div>
...
<div class="row">
    <div class="col-sm-12">
        <p style="width:100%; text-align:justify; padding-right:10px;">
            <?php if (!empty($row->berdasarkan_surat)): ?>
                Berdasarkan surat
                <?= ($row->berdasarkan_surat); ?>
            <?php endif; ?>
            <?php if (!empty($row->berdasarkan_nomor_surat)): ?>
                Nomor
                <?= ($row->berdasarkan_nomor_surat); ?>,
            <?php endif; ?>
            dengan ini memberikan izin kepada yang namanya tersebut dalam lampiran surat untuk mengikuti/melakukan
            kegiatan
            <?= trim($row->nama_surat); ?>. Kegiatan tersebut akan dilaksanakan pada:<br>
        </p>
        <?php if (!empty($tanggal_kegiatan)): ?>
            <table>
                <tr>
                    <td>Hari, tanggal </td>
                    <td style="width:50px;"></td>
                ...
                <?php if (!empty($row->lokasi_kegiatan)): ?>
                    <tr>
                        <td>Tempat </td>
                        <td></td>
                        <td>:
        ...
        <?php endif; ?>
        <p style="width:100%; text-align:justify; padding-right:10px;">Demikian surat izin ini dibuat, dan selanjutnya
            menugaskan nama-nama sebagai daftar terlampir untuk menghadiri/melaksanakan kegiatan diatas dengan
            sebaik-baiknya.</p>
