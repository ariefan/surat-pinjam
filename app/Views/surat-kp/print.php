    ...
    <div style="margin-left:-15px;" class="col-sm-12">
        ...
        <?php if (count($row->peserta) == 1): ?>
                    <?php foreach ($row->peserta as $peserta): ?>
                        ...
                        <table
                            style="border-collapse: collapse; width: 55.3205%; height: 10px; border-width: 0px; border-style: none;"
                            border="1">
                            <colgroup>
                ...
                <p style="line-height: 1;">bermaksud melaksanakan
                    ...
                    <?= $formatter->format(strtotime($row->tanggal_kegiatan_selesai)); ?>. Maka dengan ini kami mohon
                    bantuan
