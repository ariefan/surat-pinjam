...
<table class="table">
  ...
  <tr class="single">
    <td colspan="2">Menyusuli Surat Permintaan Nilai ke-1 tertanggal <span>
        <?= ($prev_sp ?? ''); ?>
      </span>, kami sampaikan bahwa menurut catatan kami hingga tanggal <span>
        <?= ($tanggal_terlewat ?? ''); ?>
      </span>, Saudara belum menyerahkan nilai <span class="bold">matakuliah <span>
          <?= ($mata_kuliah ?? ''); ?>
        </span></span></td>
  </tr>
  <tr class="single">
    <td colspan="2">Berdasarkan SK Dekan FMIPA UGM Nomor : 0061/J01.1.28/HK.01.30/2018 tentang Prosedur Permintaan dan
      Penyelesaian Nilai Akhir Matakuliah Pada Program Sarjana, Magister dan Doktor di Lingkungan FMIPA UGM, apabila
      sampai dengan tanggal <span>
        <?= ($tanggal_batas_akhir ?? ''); ?>
      </span> belum menyerahkan nilai hasil ujian matakuliah tersebut diatas maka, mahasiswa peserta ujian diberikan
      nilai B.<br></td>
  </tr>
  <tr class="single">
    <td colspan="2">Atas perhatian dan bantuan Saudara diucapkan terima kasih.<br><br></td>
  </tr>
  <tr class="double">
    <td></td>
